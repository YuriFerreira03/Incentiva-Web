...
export function PerfilPage() {
  ...
  const isGoogleAccount =
    user?.avatarUrl?.includes("googleusercontent") ?? false;
        ...
        <div className="space-y-5">
          {isGoogleAccount ? (
            <div className="rounded-xl border border-white/10 bg-white/5 p-5 text-center">
              ...
              <p className="text-[13.5px] text-white font-semibold mb-1">
                Conta vinculada ao Google
              </p>
              <p className="text-[12.5px] text-slate-400">
                Sua autenticação é gerenciada pelo Google. Para alterar sua
            ...
            <>
              <div className="rounded-xl border border-white/8 bg-white/3 px-4 py-3 text-[12.5px] text-slate-400">
                Para alterar sua senha, simplesmente preencha a nova senha
                abaixo. Por segurança, você precisará confirmar.
              </div>
